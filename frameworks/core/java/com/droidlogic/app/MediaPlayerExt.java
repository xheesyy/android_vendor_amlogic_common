...
public class MediaPlayerExt extends MediaPlayer {
    ...
    private void getParameter(int key, Parcel reply) {
        if (DEBUG)
            Log.i(TAG, "[getParameter]mIBinder:" + mIBinder + ",key:" + key + ",reply:" + reply);
        if (null == mIBinder) {
            prepareIBinder();
        }
    ...
    private boolean setParameter(int key, Parcel value) {
        boolean ret = false;
        if (DEBUG)
            Log.i(TAG, "[setParameter]mIBinder:" + mIBinder + ",key:" + key + ",Parcel value:" + value);
        if (null == mIBinder) {
            prepareIBinder();
        }
    ...
    public boolean setParameter(int key, String value) {
        if (DEBUG)
            Log.i(TAG, "[setParameter]mIBinder:" + mIBinder + ",key:" + key + ",String value:" + value);
        Parcel p = Parcel.obtain();
        p.writeString(value);
    ...
    public boolean setParameter(int key, int value) {
        if (DEBUG)
            Log.i(TAG, "[setParameter]mIBinder:" + mIBinder + ",key:" + key + ",int value:" + value);
        Parcel p = Parcel.obtain();
        p.writeInt(value);
        boolean ret = setParameter(key, p);
        p.recycle();
